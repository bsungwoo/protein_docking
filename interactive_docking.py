...
def interactive_docking_pipeline():
    ...
    center_x = float(input('Enter the docking center X coordinate (default: 0): ') or 0)
    center_y = float(input('Enter the docking center Y coordinate (default: 0): ') or 0)
    center_z = float(input('Enter the docking center Z coordinate (default: 0): ') or 0)
